...
WsFedSaml2Strategy.prototype.authenticate = function (req, opts) {
  ...
  function executeSamlp(req) {
    if (req.body &&
        (self.options.protocolBinding === 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST' &&
         req.method === 'POST'
         && req.body.SAMLResponse) ||
        (self.options.protocolBinding === 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect' &&
         req.method === 'GET'
