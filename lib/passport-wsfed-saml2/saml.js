...
function isValidInResponseTo(samlResponseID, done){
  return done();
}
...
var SAML = function (options) {
  ...
  this.isValidInResponseTo = this.options.isValidInResponseTo || isValidInResponseTo;
};
...
SAML.prototype.parseAssertion = function(samlAssertion, callback) {
  ...
  var inResponseTo = samlAssertion.getAttribute('InResponseTo');
