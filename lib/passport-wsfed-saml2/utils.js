...
exports.parseSamlAssertion = function(xml, eventEmitter) {
  if (typeof xml === 'string') {
    try {
      return new xmldom.DOMParser({ events: eventEmitter, locator: {} }).parseFromString(xml);
    } catch (e) {
...
exports.parseSamlResponse = function(xml, eventEmitter) {
  if (typeof xml === 'string') {
    try {
      return new xmldom.DOMParser({ events: eventEmitter, locator: {} }).parseFromString(xml);
    } catch (e) {
