...
var Samlp = module.exports = function Samlp (options, saml) {
  ...
  this.isValidResponseID = typeof this.options.isValidResponseID === 'function'? this.options.isValidResponseID : ignoreValidationFunction;
  this.isValidInResponseTo =  typeof this.options.isValidInResponseTo === 'function'? this.options.isValidInResponseTo : ignoreValidationFunction;
};
    ...
    self.isValidResponseID(responseXML.getAttribute('ID'), function(err){
      ...
      self.isValidInResponseTo(inResponseTo, function(err){
        ...
        if (destination && destination !== self.options.destinationUrl){
          ...
          if (self.options && self.options.checkDestination){
