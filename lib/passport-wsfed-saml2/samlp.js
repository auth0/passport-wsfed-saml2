...
Samlp.prototype = {
  ...
  validateSamlResponse: function (samlResponse, callback) {
    ...
    if (self.options && self.options.checkDestination && destination && destination !== self.options.destinationUrl){
      winston.info('Destination validation error', {
        log_type: 'destination_validation_error',
        configuredRecipient: self.options.destinationUrl,
    ...
    self.extractAssertion(samlResponse, function (err, assertion) {
      ...
      self._saml.options.recipientUrl = self._saml.options.recipientUrl || self.options.recipientUrl || self.options.destinationUrl;
      if (isResponseSigned) {
